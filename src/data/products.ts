...
export const products: Product[] = [
  {
    ...
    description:
      "Citronlemonad när den är som bäst. En 3 liter bag in box med en härlig smak av citroner från medelhavet. Färskpressad citron gör den helt underbar att dricka.",
    unitPrice: 180,
    casePrice: 720,
    caseSize: 4,
    unitLabel: "Box",
  ...
  },
  {
    ...
    description:
      "3 liters Jordgubbslemonad på riktiga jordgubbar. Får en att längta tillbaka till barndomen",
    unitPrice: 180,
    casePrice: 720,
    caseSize: 4,
    unitLabel: "Box",
  ...
  },
  {
    ...
    description:
      "Klassisk sockerlag som innehåller Socker, vatten samt konserveringsmedel E 202",
    unitPrice: 59,
    casePrice: 1416,
    caseSize: 24,
    unitLabel: "Flaska",
  ...
  },
  {
    ...
    description:
      "En sockerlag med smak av Hallon. Hallonsockerlag ger en härlig fruktig och söt smak som passar perfekt i många drinkar!",
    unitPrice: 59,
    casePrice: 1416,
    caseSize: 24,
    unitLabel: "Flaska",
  ...
  },
  {
    ...
    description:
      "Sockerlag gjort på Rabarber. Innehåller Rabarber Socker Vatten samt konserveringsmedel E 202",
    unitPrice: 59,
    casePrice: 1416,
    caseSize: 24,
    unitLabel: "Flaska",
  ...
  },
  {
    ...
    description:
      "En sockerlag med smaker av klassisk mynta idealisk för att skapa en fräscha drinkar",
    unitPrice: 59,
    casePrice: 1416,
    caseSize: 24,
    unitLabel: "Flaska",
  ...
  },
  {
    ...
    name: "Limoncello",
    description:
      "Flaskan innehåller en frisk, solkysst citronlikör med rötterna i Medelhavet men med hjärtat djupt förankrat i svensk hantverkstradition. Perfekt att avnjuta välkyld som avec – eller som en strålande ingrediens i dina favoritdrinkar. I det lilla fiskesamhället Glommen, strax utanför Falkenberg, skalas och förbereds citronerna för hand innan de varsamt macereras i alkohol för att locka fram sin intensiva och naturliga smak.  Resultatet är en magisk svensk limoncello som tar dig raka vägen till känslan av en solig sommar i Italien.",
    unitPrice: 279,
    casePrice: 1674,
    caseSize: 6,
    unitLabel: "Flaska",
  ...
  },
  {
    ...
    description:
      "Citronlemonad när den är som bäst. Färskpressad citron gör den helt underbar att dricka.",
    unitPrice: 20,
    casePrice: 480,
    caseSize: 24,
    unitLabel: "Flaska",
